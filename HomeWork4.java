public class HomeWork4 {
    public static void main(String[] args) {
        ...
        short distance = 95;
        byte days = 1;
        if (distance < 20) System.out.println("Доставка займёт " + days + "день");
        else if (distance >= 20 && distance < 60) System.out.println("Доставка займёт " + (days + 1) + " cуток");
        else if (distance < 100) System.out.println("Доставка займёт " + (days + 2) + " суток");
        ...
        if (month >= 1 && month <= 12) {
            switch (month) {
                ...
                case 1:
                case 2:
                    System.out.println("Декабрь, январь, февраль - ЗИМА!");
                    break;
                case 3:
                case 4:
                case 5:
                    System.out.println("Март, апрель, май - ВЕСНА!");
                    break;
                case 6:
                case 7:
                case 8:
                    System.out.println("Июнь, июль, август - ЛЕТО!");
                    break;
                case 9:
                case 10:
                case 11:
                    System.out.println("Сентябрь, октябрь, ноябрь - ОСЕНЬ!");
            }
        } else System.out.println("Фатальная ошибка, номер месяца в диапазоне [1;12]");
    }
}